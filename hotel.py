...
def Home():
    while True:
                ...
                print("***************** WELCOME TO HOTEL PARADISE VALLEY*************")
                print("1 Booking")
                print("2 Rooms Info")
                ...
                print("5 Record")
                print("0 Exit")
                ch=int(input("ENTER FROM 1 TO 5 OR 0:"))
...
def Booking():
                                ...
                                while rn in rm or cid in custid:
...
def Rooms_Info():
                ...
                print("These facilites are complimentary with your room package.")
                print("")
...
def restaurant():
                ...
                for n in range(0,i):
                                if custid[n]==ph and p[n]==0:
                                                f=1
                                                print("-------------------------------------------------------------------------")
                                                print("                HOTEL PARADISE VALLEY    ")
                                                print("-------------------------------------------------------------------------")
                                                print("                     Menu Card")
                                                print("-------------------------------------------------------------------------")
                                                print("\n BEVARAGES AND STARTERS")
                                                print("------------------------------------")
                                                ...
                                                print(" 14 Sweet Corn............. 110.00")
                                                print(" 15 Veg. Munchow........... 110.00")
                                                
                                                print(" MAIN COURSE")
                                                print("------------------------------------")
                                                print(" 16 Shahi Paneer........... 110.00")
                                                print(" 17 Kadai Paneer........... 110.00")
                                                print(" 18 Handi Paneer........... 120.00")
                                                print(" 19 Palak Paneer........... 120.00")
                                                print(" 20 Chilli Paneer.......... 140.00")
                                                print(" 21 Matar Mushroom......... 140.00")
                                                print(" 22 Mix Veg................ 140.00")
                                                print(" 23 Jeera Aloo............. 140.00")
                                                print(" 24 Malai Kofta............ 140.00")
                                                print(" 25 Aloo Matar............. 140.00")
                                                print(" 26 Dal fry................ 140.00")
                                                print(" 27 Dal makhani............ 150.00")
                                                print(" 28 Dal tadka.............. 150.00")
                                                print("")
                                                print("ROTI")
                                                print("---------------------------------------")
                                                print(" 29 Plain Roti.............. 15.00")
                                                print(" 30 Butter Roti............. 15.00")
                                                print(" 31 Tandoori Roti........... 20.00")
                                                print(" 32 Butter Naan............. 20.00")
                                                print("")
                                                print("RICE")
                                                print("-----------------------------------------")
                                                print(" 33 Plain Rice.............. 90.00")
                                                print(" 34 Jeera Rice.............. 90.00")
                                                print(" 35 Veg Pulao.............. 110.00")
                                                print(" 36 Peas Pulao............. 110.00")
                                                print("")
                                                print("SOUTH INDIAN")
                                                print("----------------------------------------")
                                                print(" 37 Plain Dosa............. 100.00")
                                                print(" 38 Onion Dosa............. 110.00")
                                                print(" 39 Masala Dosa............ 130.00")
                                                print(" 40 Paneer Dosa............ 130.00")
                                                print(" 41 Rice Idli.............. 130.00")
                                                print(" 42 Sambhar Vada........... 140.00")
                                                print("")
                                                print("ICE CREAM")
                                                print("--------------------------------------------")
                                                print(" 43 Vanilla................. 60.00")
                                                print(" 44 Strawberry.............. 60.00")
                                                print(" 45 Pineapple............... 60.00")
                                                print(" 46 Butterscotch............ 60.00")
...
def Record():
                ...
                if phno!=[]:
                                ...
                                for n in range(0,i):
                                                print("|",nm[n],"\t |",phno[n],"\t|",add[n],"\t|",checkin[n],"\t|",checkout[n],"\t|",room[n],"\t|",price[n])                    
                                print("----------------------------------------------------------------------------------------------------------------------")
